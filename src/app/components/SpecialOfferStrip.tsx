        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="text-white">
              <h3 className="text-xl md:text-2xl mb-1">Flash Sale Alert! 🎊</h3>
              <p className="text-white/90 text-sm md:text-base">
                Book any trip in next 24 hours and get <span className="font-bold text-secondary">FLAT ₹2,000 OFF</span> + Free Travel Insurance
              </p>
            </div>
          </div>
